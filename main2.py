...
st.set_page_config(page_title="App support-resistance-flag", page_icon=":material/analytics:", layout="wide")
    ...
    if not ticker_input:
        ...
        with st.spinner(f"Obteniendo datos de {ticker_input}.US desde Stooq..."):
            ...
            if not df.empty:
                ...
                st.subheader(f"Resultados para {ticker_input.upper()}.US")
